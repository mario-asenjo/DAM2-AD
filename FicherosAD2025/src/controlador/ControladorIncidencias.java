                    ...
                    case 2:
                        ...
                        switch (opcionVisualizacion) {
                            case 1:
                                ...
                                listaFiltrada = servicioFichero.buscarPorUsuario(usuarioBusqueda);
                                Consola.mostrarArrayListString(listaFiltrada);
                                break;
                            case 2:
                                ...
                                listaFiltrada = servicioFichero.buscarPorRangoFechas(fechaBusquedaInicial, fechaBusquedaFinal);
                                Consola.mostrarArrayListString(listaFiltrada);
                        }
                }
