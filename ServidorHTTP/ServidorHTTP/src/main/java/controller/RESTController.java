...
@RequestMapping("/app")  // Prefijo de la ruta para los endpoints de esta API
public class RESTController {
    ...
    public List<Map<String, String>> getPersonasSQL(@RequestBody final String SQL) {
        List<Map<String, String>> ret = List.of(Map.of(SQL, "Primer Valor"), Map.of("Segunda Clave", "Segundo Valor"));
        return ret;
    }
}
